  ...
  <div>
    ...
    >
        ...
        <div class="w-full md:w-8/12 lg:w-6/12 xl:w-6/12 px-4">
          <div class="pt-32 sm:pt-0">
            <h2 class="font-semibold text-4xl text-blueGray-600">
              C.O.D(ot) - Distributor
            </h2>
            <p class="mt-4 text-lg leading-relaxed text-blueGray-500">
              Distributor buah import dengan kualitas dan rasa terbaik di
              Surabaya.
              <a
      ...
      <img
        ...
        :src="require('~/assets/img/pattern_vue.png')"
        alt="..."
      />
    </section>
          ...
          >
            ...
            >
              ...
              <blockquote class="relative p-8 mb-4">
                ...
                <h4 class="text-xl font-bold text-white">About C.O.D(ot)</h4>
                <p class="text-md font-light mt-2 text-white">
                  C.O.D(ot) - Distributor. Distributor buah import dengan
                  kualitas dan rasa terbaik yang ada di kota Surabaya.
                </p>
              </blockquote>
            </div>
          </div>
...
export default {
  ...
  data() {
    return {
      ...
      componentProfileCard: componentProfileCard,
      componentInfoCard: componentInfoCard,
      componentInfo2: componentInfo2,
      componentMenu: componentMenu,
      componentBtnPink: componentBtnPink,
